...
export default function DisableWarrantyModal({ selectedWarranty, onClose }) {
  const { handleSubmit, loading } = useDisableWarranty(selectedWarranty.id);

  return (
    <div className="flex flex-col items-center">
      <p className="text-center">
        ¿Estás seguro de que deseas deshabilitar al garantía del producto con el serial {""}
        <span className="font-medium">
          {selectedWarranty?.product_serial}
        </span>
        ?
      </p>
