...
export default function KpiCard({ title, background, metricValue, growth }) {
  return (
    <section
      className={`h-full row-span-1 col-span-1 flex flex-col p-4 shadow-md border border-gray-200 rounded-3xl transition duration-500
        hover:scale-[1.005]
        md:col-span-3
        dark:bg-[#101012b9] dark:border-[#ffffff10] dark:text-white ${background}`}
    >
