...
export default function DateField({
  ...
  return (
    <div
      tabIndex={0}
      onClick={onClick}
      className="relative w-full h-[60px] flex px-4 rounded-2xl border outline-[#00000028] text-center cursor-pointer shadow-sm
    dark:border-[#1e1e20cb] text-sm dark:text-white focus:shadow-[0_0_2px_1px_#e5e7eb]"
    >
      <div className="min-w-full max-w-full flex items-center pr-1.5">
